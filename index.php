    ...
    <div class="wrapper">
        <div class="sidebar-wrapper">
            <div class="profile-container">
                <img class="profile" src="assets/images/profile.jpg" alt="" height="150px"/>
            ...
            <div class="contact-container container-block">
                <ul class="list-unstyled contact-list">
                    ...
                    <li class="website"><i class="fa fa-globe"></i><a href="<?= $aboutData['site'] ?>" target="_blank">portfolio site</a></li>
            ...
            <div class="languages-container container-block">
                ...
                <ul class="list-unstyled interests-list">
                    ...
                    <li><?=$lang?> <span class="lang-desc"></span></li>
                    <? } ?>
                </ul>
            </div><!--//interests-->
        ...
        <div class="main-wrapper">
            ...
            <section class="section projects-section">
                ...
                <? foreach ($projects as $dft) { ?>
                <div class="item">
                    <span class="project-title"><a href="<?= $dft['link']?>"><?= $dft['title']?></a></span> - <span class="project-tagline"><?= $dft['about']?></span>
                </div><!--//item-->
                <? } ?>
            </section><!--//section-->
